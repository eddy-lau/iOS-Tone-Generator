...
- (IBAction)makeSound:(UIButton *)sender {
    ...
    if (c == '0') {
        _generator.channels[0].frequency = 1336;
        _generator.channels[1].frequency = 941;
    } else if ('0' < c && c <= '9') {
        c = c -'1';
        _generator.channels[0].frequency = freqA[c % 3];
        _generator.channels[1].frequency = freqB[c / 3];
    } else if (c == '#') {
        _generator.channels[0].frequency = 1477;
        _generator.channels[1].frequency = 941;
    } else {// Not sure
        _generator.channels[0].frequency = 1209;
        _generator.channels[1].frequency = 941;
    }
